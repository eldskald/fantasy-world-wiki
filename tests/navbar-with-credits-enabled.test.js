...
describe("navbar with credits enabled", () => {
    ...
    test("should have indexes, credits and theme switcher", () => {
        ...
        expect(links[0].getAttribute("tomap")).toBe("");
        expect(links[1].getAttribute("tomenu")).toBe("articles-index");
        expect(links[2].getAttribute("tomenu")).toBe("maps-index");
        expect(links[3].getAttribute("tomenu")).toBe("credits");
